...
def makeVizPlot(inputDF, inputLandings, inputTakeoffs):
    ...
    ax.legend()
    ax1.plot(inputDF.RKneeAngle_Sagittal[inputLandings[0]:inputTakeoffs[3]], label = 'Right Sagittal')
    ax1.plot(inputDF.LKneeAngle_Sagittal[inputLandings[0]:inputTakeoffs[3]], label = 'Left Sagittal')
    ...
    ax2.plot(inputDF.RHipAngle_Sagittal[inputLandings[0]:inputTakeoffs[3]], label = 'Right Sagittal')
    ax2.plot(inputDF.LHipAngle_Sagittal[inputLandings[0]:inputTakeoffs[3]], label = 'Left Sagittal')
    ax2.plot(inputDF.RHipAngle_Frontal[inputLandings[0]:inputTakeoffs[3]], label = 'Right Frontal')
    ax2.plot(inputDF.LHipAngle_Frontal[inputLandings[0]:inputTakeoffs[3]], label = 'Left Frontal')
    ...
    fig2, (ax, ax1, ax2) = plt.subplots(1,3)
    ...
    ax2.plot(inputDF.RHipMoment_Sagittal[inputLandings[0]:inputTakeoffs[3]], label = 'Right Sagittal')
    ax2.plot(inputDF.LHipMoment_Sagittal[inputLandings[0]:inputTakeoffs[3]], label = 'Left Sagittal')
    ax2.set_xlabel('Indices')
    ax2.set_title('Hip')
